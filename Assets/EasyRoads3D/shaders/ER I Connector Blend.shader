	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float3 unpack5 = UnpackNormalScale( tex2D( _BumpMap, texCoord41 ), _BumpScale1 );
				unpack5.z = lerp( 1, unpack5.z, saturate(_BumpScale1) );
				float2 texCoord35 = IN.ase_texcoord7.zw * float2( 1,1 ) + float2( 0,0 );
				float3 unpack23 = UnpackNormalScale( tex2D( _BumpMap2, texCoord35 ), _BumpScale2 );
				...
				float2 texCoord36 = IN.ase_texcoord7.zw * float2( 1,1 ) + float2( 0,0 );
